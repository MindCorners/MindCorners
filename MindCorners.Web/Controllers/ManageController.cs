    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                ProfileFileUrl = Url.Action("GetProfileImageByName", "Manage", new{ fileName= user.UserProfile.ProfileImageString})
            };
        ...
        [HttpPost]
        public async Task<ActionResult> UpdateInfo(IndexViewModel model)
        {
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                //var userDb = context.Users.FirstOrDefault(p => p.Id == User.Identity.GetUserId());
                var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
                if (user != null)
                {
                   ...
                   // user.UserProfile.ProfileImageString =
        ...
        public FileResult GetProfileImageByName(string fileName)
        {
            return DownloadBlob("profile-images", fileName);
        }
