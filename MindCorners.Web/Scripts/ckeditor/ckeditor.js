...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = { timestamp: "F7J9", version: "4.5.3", revision: "6c70c82", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
...
CKEDITOR.tools.objectCompare(k.attributes, m.attributes, true) ? true : false; typeof a == "string" && (this._.cachedChecks[e] = b); return b
        ...
        }; var C = { styles: 1, attributes: 1, classes: 1 }, x = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, D = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, G = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, M = /^cke:(object|embed|param)$/, aa = /^(object|embed|param)$/, U = CKEDITOR.filter.transformationsTools = { sizeToStyle: function (a) {
...
0; g < d.length; g++) { var p = d[g]; f === 0 && (e[g] && p.lang && p.langEntries) && (a.lang[p.name] = p.langEntries[e[g]]); if (p[c[f]]) p[c[f]](a) } a.fireOnce("pluginsLoaded"); b.keystrokes && a.setKeystroke(a.config.keystrokes); for (g = 0; g < a.config.blockedKeystrokes.length; g++) a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[g]] = 1; a.status = "loaded"; a.fireOnce("loaded"); CKEDITOR.fire("instanceLoaded", null, a)
        ...
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var r = 0, y = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, { addCommand: function (a, b) { b.name = a.toLowerCase(); var d = new CKEDITOR.command(this, b); this.mode && c(this, d); return this.commands[a] = d }, _attachToForm: function () {
...
1); e && d(e, b[b.length - 1]); if (g && d(g, b[0])) { c.setEnd(c.endContainer, c.endOffset - 1); c.collapse() } 
        ...
        var n = l.editor, o = false; if (x == "unfiltered_html") { x = "html"; o = true } if (!G.checkReadOnly()) {
            var E = (new CKEDITOR.dom.elementPath(G.startContainer, G.root)).blockLimit || G.root, l = { type: x, dontFilter: o,
...
}; d = { exclude: function (a) { var b = a.range.getBoundaryNodes(), c = b.startNode; (b = b.endNode) && (w(b) && (!c || !c.equals(b))) && a.range.setEndBefore(b) } }; c = { rebuild: function (a, b) {
    var c = a.range,
...
}, block: { detectMerge: function (a, b) { if (!a.tableContentsRanges && !a.mergeListBookmark) { var c = new CKEDITOR.dom.range(b); c.setStartBefore(a.bookmark.startNode); c.setEndAfter(a.bookmark.endNode); a.mergeBlockBookmark = c.createBookmark() } }, merge: function (a, c) {
...
function (a, c) { c = c || {}; return CKEDITOR.tools.extend({ id: "ok", type: "button", label: a.lang.common.ok, "class": "cke_dialog_ui_button_ok", onClick: function (a) { a = a.data.dialog; !1 !== a.fire("ok", { hide: !0 }).hide && a.hide() } }, c, !0) }; a.type = "button"; a.override = function (b) { return CKEDITOR.tools.extend(function (c) { return a(c, b) }, { type: "button" }, !0) }; return a
            ...
            var a = function (a, c) {
                c = c || {}; return CKEDITOR.tools.extend({ id: "cancel", type: "button", label: a.lang.common.cancel, "class": "cke_dialog_ui_button_cancel",
        ...
        }); CKEDITOR.dialog._ = { uiElementBuilders: {}, dialogDefinitions: {}, currentTop: null, currentZIndex: null }; CKEDITOR.event.implementOn(CKEDITOR.dialog); CKEDITOR.event.implementOn(CKEDITOR.dialog.prototype); var W = { resizable: CKEDITOR.DIALOG_RESIZE_BOTH,
...
(n = e.once("blur", function () { b.lockSelection(i) })); var p = CKEDITOR.document.getWindow().getScrollPosition().y; setTimeout(function () { if (CKEDITOR.env.webkit) CKEDITOR.document.getBody().$.scrollTop = p; n && n.removeListener(); CKEDITOR.env.ie && e.focus(); g.selectBookmarks(h); j.remove(); var a; if (CKEDITOR.env.webkit && (a = j.getFirst()) && a.is && a.hasClass("Apple-style-span")) j = a; b.removeListener("selectionChange", f); d(j.getHtml()) }, 0)
                ...
                if ("paste" == k.mainPasteEvent) return b.fire("beforePaste", { type: "auto",
                    method: "paste"
...
(a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g, function (b) { return c(b.length / 4) }) + "</p>")); return y(b, a)
            ...
            function b() { var b = {}, a; for (a in CKEDITOR.dtd) "$" != a.charAt(0) && ("div" != a && "span" != a) && (b[a] = 1); return b } var a, c; return { get: function (d) {
...
h ? "html" : "text"); a.type = e; a.dataValue = g; delete a.preSniffing; delete a.startsWithEOL; delete a.endsWithEOL
        ...
        }); CKEDITOR.plugins.clipboard = { isCustomCopyCutSupported: !CKEDITOR.env.ie && !CKEDITOR.env.iOS, isCustomDataTypesSupported: !CKEDITOR.env.ie, isFileApiSupported: !CKEDITOR.env.ie ||
...
c.entities_additional && e.push(c.entities_additional)); var a = i(e.join(",")), d = a.regex ? "[" + a.regex + "]" : "a^"; delete a.regex; c.entities && c.entities_processNumerical && (d = "[^ -~]|" + d); var d = RegExp(d, "g"), h = i("nbsp,gt,lt,amp,shy", !0), j = RegExp(h.regex, "g"); b.addRules({ text: function (a) { return a.replace(j, f).replace(d, g) } }, { applyToAll: !0, excludeNestedEditable: !0 })
    ...
    CKEDITOR.config.entities_additional = "#39"; CKEDITOR.plugins.add("find", { requires: "dialog", init: function (a) {
...
d.contentsCss; CKEDITOR.tools.isArray(b) || (d.contentsCss = b ? [b] : []); d.contentsCss.push(a)
        }; var j = CKEDITOR.tools.createClass({ $: function () { this.base.apply(this, arguments); this._.frameLoadedHandler = CKEDITOR.tools.addFunction(function (a) { CKEDITOR.tools.setTimeout(k, 0, this, a) }, this); this._.docTitle = this.getWindow().getFrame().getAttribute("title") }, base: CKEDITOR.editable, proto: { setData: function (a, d) {
...
arguments); this.setValue(this.getValue().replace(/cke_show_border/, ""))
        ...
        function h(a) {
            function k() { d = a.document; l = d[CKEDITOR.env.ie ? "getBody" : "getDocumentElement"](); c = CKEDITOR.env.quirks ? d.getBody() : d.getDocumentElement(); e = CKEDITOR.dom.element.createFromHtml('<span style="margin:0;padding:0;border:0;clear:both;width:1px;height:1px;display:block;">' + (CKEDITOR.env.webkit ? "&nbsp;" : "") + "</span>", d) } function f() {
                i && c.setStyle("overflow-y", "hidden"); var g = a.window.getViewPaneSize().height, b; l.append(e); b = e.getDocumentPosition(d).y + e.$.offsetHeight; e.remove();
                b += h; b = Math.max(b, o); b = Math.min(b, m); b != g && j != b && (b = a.fire("autoGrow", { currentHeight: g, newHeight: b }).newHeight, a.resize(a.container.getStyle("width"), b, !0), j = b); i || (b < m && c.$.scrollHeight > c.$.clientHeight ? c.setStyle("overflow-y", "hidden") : c.removeStyle("overflow-y"))
            } var j, d, l, c, e, h = a.config.autoGrow_bottomSpace || 0, o = void 0 !== a.config.autoGrow_minHeight ? a.config.autoGrow_minHeight : 200, m = a.config.autoGrow_maxHeight || Infinity, i = !a.config.autoGrow_maxHeight; a.addCommand("autogrow", { exec: f, modes: { wysiwyg: 1 },
                readOnly: 1, canUndo: !1, editorFocus: !1
            }); var p = { contentDom: 1, key: 1, selectionChange: 1, insertElement: 1, mode: 1 }, n; for (n in p) a.on(n, function (g) { "wysiwyg" == g.editor.mode && setTimeout(function () { var b = a.getCommand("maximize"); !a.window || b && b.state == CKEDITOR.TRISTATE_ON ? j = null : (f(), i || f()) }, 100) }); a.on("afterCommandExec", function (a) { "maximize" == a.data.name && "wysiwyg" == a.editor.mode && (a.data.command.state == CKEDITOR.TRISTATE_ON ? c.removeStyle("overflow-y") : f()) }); a.on("contentDom", k); k(); a.config.autoGrow_onStartup &&
...
}; CKEDITOR.plugins.add("autocorrect", { requires: "menubutton", lang: "en,ru", init: function (g) {
...
1
    ...
    } function ba(a, f) { switch (f) { case "1": return a | 0; case "i": return j(a.toUpperCase()); case "I": return j(a); case "a": return O(a.toUpperCase()); case "A": return O(a) } } var u = g.config, v = g.lang.autocorrect; P(); g.addCommand("autocorrect", { exec: function (a) {
...
a.data.keyCode && 13 != a.data.keyCode) && z() && "wysiwyg" === g.mode) { var f = g.getSelection().getRanges().shift(), b = null; 13 === a.data.keyCode && (a = l(f.startContainer), "p" === a.getName() && (b = a)); setTimeout(function () { o = true; K(f); L(b); o = false }) } 
    ...
    CKEDITOR.config.autocorrect_formatBulletedListsAsYouType = !0; CKEDITOR.config.autocorrect_formatBulletedLists = !0; CKEDITOR.config.autocorrect_formatNumberedListsAsYouType = !0; CKEDITOR.config.autocorrect_formatNumberedLists = !0; CKEDITOR.plugins.add("backgrounds", { init: function (a) { a.addFeature && a.addFeature({ name: "background image", allowedContent: { "table td th": { propertiesOnly: !0, attributes: "background"}} }) } });
    CKEDITOR.on("dialogDefinition", function (a) {
        var b = a.data.name, c = a.data.definition, e = a.editor, a = ""; if ("table" == b || "tableProperties" == b) a = "advanced"; "cellProperties" == b && (a = "info"); if ("" != a && (c = c.getContents(a))) {
            var d = { type: "text", label: e.lang.backgrounds.label, id: "background", setup: function (a) { this.setValue(a.getAttribute("background")) }, commit: function (a, b) { var c = b || a, d = this.getValue(); d ? c.setAttribute("background", d) : c.removeAttribute("background") } }; d.requiredContent = "cellProperties" == b ? "td[background];th[background]" :
"table[background]"; b = { type: "button", id: "browse", hidden: "true", filebrowser: { action: "Browse", target: a + ":background", url: e.config.filebrowserImageBrowseUrl || e.config.filebrowserBrowseUrl }, label: e.lang.common.browseServer, requiredContent: d.requiredContent }; "advanced" == a ? (c.add(d), c.add(b)) : (b.style = "display:inline-block;margin-top:10px;", c.add({ type: "hbox", widths: ["", "100px"], children: [d, b], requiredContent: d.requiredContent }))
        } 
    }, null, null, 9);
    CKEDITOR.skins ? (CKEDITOR.plugins.setLang("backgrounds", "en", { backgrounds: { label: "Background image"} }), CKEDITOR.plugins.setLang("backgrounds", "es", { backgrounds: { label: "Imagen de fondo"} })) : (CKEDITOR.plugins.setLang("backgrounds", "en", { label: "Background image" }), CKEDITOR.plugins.setLang("backgrounds", "es", { label: "Imagen de fondo" })); CKEDITOR.plugins.add("base64image", { lang: "af ar bg bn bs ca cs cy da de el en en-au en-ca en-gb eo es et eu fa fi fo fr fr-ca gl gu he hi hr hu id is it ja ka km ko ku lt lv mk mn ms nb nl no pl pt pt-br ro ru si sk sl sq sr sr-latn sv th tr ug uk vi zh zh-cn".split(" "), requires: "dialog", icons: "base64image", hidpi: !0, init: function (a) {
...
(b.data.dialog = "base64imageDialog", a.getSelection().selectElement(b.data.element))
        ...
        function k(a, d) { CKEDITOR.tools.extend(this, { editor: a, editable: a.editable(), doc: a.document, win: a.window }, d, !0); this.inline = this.editable.isInline(); this.inline || (this.frame = this.win.getFrame()); this.target = this[this.inline ? "editable" : "doc"] } function l(a, d) { CKEDITOR.tools.extend(this, d, { editor: a }, !0) } function m(a, d) {
...
d, !0); this.hidden = {}; this.visible = {}; this.inline || (this.frame = this.win.getFrame()); this.queryViewport(); var c = CKEDITOR.tools.bind(this.queryViewport, this), e = CKEDITOR.tools.bind(this.hideVisible, this), g = CKEDITOR.tools.bind(this.removeAll, this); b.attachListener(this.winTop, "resize", c); b.attachListener(this.winTop, "scroll", c); b.attachListener(this.winTop, "resize", e); b.attachListener(this.win, "scroll", e); b.attachListener(this.inline ? b : this.frame, "mouseout", function (a) {
    ...
    this.queryViewport(); (b <= this.rect.left || b >= this.rect.right || a <= this.rect.top || a >= this.rect.bottom) && this.hideVisible(); (b <= 0 || b >= this.winTopPane.width || a <= 0 || a >= this.winTopPane.height) && this.hideVisible()
}, this); b.attachListener(a, "resize", c); b.attachListener(a, "mode", g); a.on("destroy", g); this.lineTpl = (new CKEDITOR.template(p)).output({ lineStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, q, this.lineStyle, !0)), tipLeftStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, n, { left: "0px",
    "border-left-color": "red", "border-width": "6px 0 6px 6px"
}, this.tipCss, this.tipLeftStyle, !0)), tipRightStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, n, { right: "0px", "border-right-color": "red", "border-width": "6px 6px 6px 0" }, this.tipCss, this.tipRightStyle, !0))
})
        } function j(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && !(o[a.getComputedStyle("float")] || o[a.getAttribute("align")]) && !r[a.getComputedStyle("position")] } CKEDITOR.plugins.add("lineutils"); CKEDITOR.LINEUTILS_BEFORE = 1; CKEDITOR.LINEUTILS_AFTER =
2; CKEDITOR.LINEUTILS_INSIDE = 4; k.prototype = { start: function (a) {
...
this.editable : this.frame, "mouseout", function () { i.reset() })
}, stop: function () { this.listener && this.listener.removeListener() }, getRange: function () { var a = {}; a[CKEDITOR.LINEUTILS_BEFORE] = CKEDITOR.POSITION_BEFORE_START; a[CKEDITOR.LINEUTILS_AFTER] = CKEDITOR.POSITION_AFTER_END; a[CKEDITOR.LINEUTILS_INSIDE] = CKEDITOR.POSITION_AFTER_START; return function (d) { var b = this.editor.createRange(); b.moveToPosition(this.relations[d.uid].element, a[d.type]); return b } } (), store: function () {
    function a(a, b, c) {
        var e = a.getUniqueId();
        e in c ? c[e].type |= b : c[e] = { element: a, type: b}
    } return function (d, b) { var c; if (b & CKEDITOR.LINEUTILS_AFTER && j(c = d.getNext()) && c.isVisible()) a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), b ^= CKEDITOR.LINEUTILS_AFTER; if (b & CKEDITOR.LINEUTILS_INSIDE && j(c = d.getFirst()) && c.isVisible()) a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), b ^= CKEDITOR.LINEUTILS_INSIDE; a(d, b, this.relations) } 
} (), traverseSearch: function (a) {
    var d, b, c; do if (c = a.$["data-cke-expando"], !(c && c in this.relations)) {
    ...
    function a(a, c, e, g, f) { for (var h = 0, i; f(e); ) { e += g; if (25 == ++h) break; if (i = this.doc.$.elementFromPoint(c, e)) if (i == a) h = 0; else if (d(a, i) && (h = 0, j(i = new CKEDITOR.dom.element(i)))) return i } } var d = CKEDITOR.env.ie || CKEDITOR.env.webkit ? function (a, c) { return a.contains(c) } : function (a, c) {
...
16)
    ...
    this.relations =
{}; for (var a = this.editable.getElementsByTag("*"), d = 0, b, c, e; b = a.getItem(d++); ) if (!b.equals(this.editable) && b.type == CKEDITOR.NODE_ELEMENT && (b.hasAttribute("contenteditable") || !b.isReadOnly()) && j(b) && b.isVisible()) for (e in this.lookups) (c = this.lookups[e](b)) && this.store(b, c); return this.relations
} 
}; l.prototype = { locate: function () {
    function a(a, b) {
        var c = a.element[b === CKEDITOR.LINEUTILS_BEFORE ? "getPrevious" : "getNext"](); return c && j(c) ? (a.siblingRect = c.getClientRect(), b == CKEDITOR.LINEUTILS_BEFORE ? (a.siblingRect.bottom +
...
(b.elementRect.top + b.elementRect.bottom) / 2); return this.locations
    } 
} (), sort: function () { var a, d, b, c; return function (e, g) { a = this.locations; d = []; for (var f in a) for (var h in a[f]) if (b = Math.abs(e - a[f][h]), d.length) { for (c = 0; c < d.length; c++) if (b < d[c].dist) { d.splice(c, 0, { uid: +f, type: h, dist: b }); break } c == d.length && d.push({ uid: +f, type: h, dist: b }) } else d.push({ uid: +f, type: h, dist: b }); return "undefined" != typeof g ? d.slice(0, g) : d } } (), store: function (a, d, b) {
    this.locations[a] || (this.locations[a] = {}); this.locations[a][d] =
b
} 
}; var n = { display: "block", width: "0px", height: "0px", "border-color": "transparent", "border-style": "solid", position: "absolute", top: "-6px" }, q = { height: "0px", "border-top": "1px dashed red", position: "absolute", "z-index": 9999 }, p = '<div data-cke-lineutils-line="1" class="cke_reset_all" style="{lineStyle}"><span style="{tipLeftStyle}">&nbsp;</span><span style="{tipRightStyle}">&nbsp;</span></div>'; m.prototype = { removeAll: function () {
    for (var a in this.hidden) this.hidden[a].remove(), delete this.hidden[a]; for (a in this.visible) this.visible[a].remove(),
delete this.visible[a]
}, hideLine: function (a) { var d = a.getUniqueId(); a.hide(); this.hidden[d] = a; delete this.visible[d] }, showLine: function (a) { var d = a.getUniqueId(); a.show(); this.visible[d] = a; delete this.hidden[d] }, hideVisible: function () { for (var a in this.visible) this.hideLine(this.visible[a]) }, placeLine: function (a, d) {
    var b, c, e; if (b = this.getStyle(a.uid, a.type)) {
        for (e in this.visible) if (this.visible[e].getCustomData("hash") !== this.hash) { c = this.visible[e]; break } if (!c) for (e in this.hidden) if (this.hidden[e].getCustomData("hash") !==
this.hash) { this.showLine(c = this.hidden[e]); break } c || this.showLine(c = this.addLine()); c.setCustomData("hash", this.hash); this.visible[c.getUniqueId()] = c; c.setStyles(b); d && d(c)
    } 
...
}, addLine: function () { var a = CKEDITOR.dom.element.createFromHtml(this.lineTpl); a.appendTo(this.container); return a }, prepare: function (a, d) {
    this.relations =
a; this.locations = d; this.hash = Math.random()
...
}; var o = { left: 1, right: 1, center: 1 }, r = { absolute: 1, fixed: 1 }; CKEDITOR.plugins.lineutils = { finder: k, locator: l, liner: m}
    })(); (function () {
        function n(a) { this.editor = a; this.registered = {}; this.instances = {}; this.selected = []; this.widgetHoldingFocusedEditable = this.focused = null; this._ = { nextId: 0, upcasts: [], upcastCallbacks: [], filters: {} }; C(this); D(this); this.on("checkWidgets", E); this.editor.on("contentDomInvalidated", this.checkWidgets, this); F(this); G(this); H(this); I(this); J(this) } function h(a, b, c, d, e) {
            var f = a.editor; CKEDITOR.tools.extend(this, d, { editor: f, id: b, inline: "span" == c.getParent().getName(), element: c, data: CKEDITOR.tools.extend({},
"function" == typeof d.defaults ? d.defaults() : d.defaults), dataReady: !1, inited: !1, ready: !1, edit: h.prototype.edit, focusedEditable: null, definition: d, repository: a, draggable: !1 !== d.draggable, _: { downcastFn: d.downcast && "string" == typeof d.downcast ? d.downcasts[d.downcast] : d.downcast}
            }, !0); a.fire("instanceCreated", this); K(this, d); this.init && this.init(); this.inited = !0; (a = this.element.data("cke-widget-data")) && this.setData(JSON.parse(decodeURIComponent(a))); e && this.setData(e); this.data.classes || this.setData("classes",
this.getClasses()); this.dataReady = !0; p(this); this.fire("data", this.data); this.isInited() && f.editable().contains(this.wrapper) && (this.ready = !0, this.fire("ready"))
        } function o(a, b, c) { CKEDITOR.dom.element.call(this, b.$); this.editor = a; this._ = {}; b = this.filter = c.filter; CKEDITOR.dtd[this.getName()].p ? (this.enterMode = b ? b.getAllowedEnterMode(a.enterMode) : a.enterMode, this.shiftEnterMode = b ? b.getAllowedEnterMode(a.shiftEnterMode, !0) : a.shiftEnterMode) : this.enterMode = this.shiftEnterMode = CKEDITOR.ENTER_BR } function L(a,
b) {
            a.addCommand(b.name, { exec: function (a, d) {
                function e() { a.widgets.finalizeCreation(i) } var f = a.widgets.focused; if (f && f.name == b.name) f.edit(); else if (b.insert) b.insert(); else if (b.template) {
                    var f = "function" == typeof b.defaults ? b.defaults() : b.defaults, f = CKEDITOR.dom.element.createFromHtml(b.template.output(f)), g, j = a.widgets.wrapElement(f, b.name), i = new CKEDITOR.dom.documentFragment(j.getDocument()); i.append(j); (g = a.widgets.initOn(f, b, d && d.startupData)) ? (f = g.once("edit", function (b) {
                        if (b.data.dialog) g.once("dialog",
function (b) { var b = b.data, d, f; d = b.once("ok", e, null, null, 20); f = b.once("cancel", function (b) { b.data && !1 === b.data.hide || a.widgets.destroy(g, !0) }); b.once("hide", function () { d.removeListener(); f.removeListener() }) }); else e()
...
d
        ...
        } function q(a, b) { a.focused = null; if (b.isInited()) { var c = b.editor.checkDirty(); a.fire("widgetBlurred", { widget: b }); b.setFocused(!1); !c && b.editor.resetDirty() } } function E(a) {
            a = a.data; if ("wysiwyg" == this.editor.mode) {
                var b = this.editor.editable(), c = this.instances, d, e, f, g; if (b) {
                    for (d in c) c[d].isReady() &&
!b.contains(c[d].wrapper) && this.destroy(c[d], !0); if (a && a.initOnlyNew) c = this.initOnAll(); else { var j = b.find(".cke_widget_wrapper"), c = []; d = 0; for (e = j.count(); d < e; d++) { f = j.getItem(d); if (g = !this.getByElement(f, !0)) { a: { g = N; for (var i = f; i = i.getParent(); ) if (g(i)) { g = !0; break a } g = !1 } g = !g && b.contains(f) } g && (f.addClass("cke_widget_new"), c.push(this.initOn(f.getFirst(h.isDomWidgetElement)))) } } a && (a.focusInited && 1 == c.length) && c[0].focus()
                } 
            } 
        } function r(a, b, c) {
            ...
            var b = [], c = a._.upcasts, d = a._.upcastCallbacks; return { toBeWrapped: b, iterator: function (a) {
                var f, g, j, i, l; if ("data-cke-widget-wrapper" in a.attributes) return (a = a.getFirst(h.isParserWidgetElement)) && b.push([a]), !1; if ("data-widget" in a.attributes) return b.push([a]), !1; if (l = c.length) {
                    if (a.attributes["data-cke-widget-upcasted"]) return !1; i = 0; for (f = d.length; i < f; ++i) if (!1 === d[i](a)) return; for (i = 0; i < l; ++i) if (f =
c[i], j = {}, g = f[0](a, j)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(j)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
        ...
        } function s(a) { return { tabindex: -1, contenteditable: "false", "data-cke-widget-wrapper": 1, "data-cke-filter": "off", "class": "cke_widget_wrapper cke_widget_new cke_widget_" + (a ? "inline" : "block")} } function t(a, b, c) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
                var d = CKEDITOR.dtd[a.name]; if (d && !d[c.name]) {
                    var d =
a.split(b), e = a.parent, b = d.getIndex(); a.children.length || (b -= 1, a.remove()); d.children.length || d.remove(); return t(e, b, c)
                } 
            } a.add(c, b)
        } function u(a, b) { return "boolean" == typeof a.inline ? a.inline : !!CKEDITOR.dtd.$inline[b] } function N(a) { return a.hasAttribute("data-cke-temp") } function m(a, b, c, d) {
            var e = a.editor; e.fire("lockSnapshot"); c ? (d = c.data("cke-widget-editable"), d = b.editables[d], a.widgetHoldingFocusedEditable = b, b.focusedEditable = d, c.addClass("cke_widget_editable_focused"), d.filter && e.setActiveFilter(d.filter),
e.setActiveEnterMode(d.enterMode, d.shiftEnterMode)) : (d || b.focusedEditable.removeClass("cke_widget_editable_focused"), b.focusedEditable = null, a.widgetHoldingFocusedEditable = null, e.setActiveFilter(null), e.setActiveEnterMode(null, null)); e.fire("unlockSnapshot")
        } function P(a) { a.contextMenu && a.contextMenu.addListener(function (b) { if (b = a.widgets.getByElement(b, !0)) return b.fire("contextMenu", {}) }) } function Q(a, b) { return CKEDITOR.tools.trim(b) } function I(a) {
            var b = a.editor, c = CKEDITOR.plugins.lineutils; b.on("dragstart",
function (c) { var e = c.data.target; h.isDomDragHandler(e) && (e = a.getByElement(e), c.data.dataTransfer.setData("cke/widget-id", e.id), b.focus(), e.focus()) }); b.on("drop", function (c) {
    var e = c.data.dataTransfer, f = e.getData("cke/widget-id"), g = b.createRange(); if (!("" === f || e.getTransferType(b) != CKEDITOR.DATA_TRANSFER_INTERNAL)) if (e = a.instances[f]) g.setStartBefore(e.wrapper), g.setEndAfter(e.wrapper), c.data.dragRange = g, delete CKEDITOR.plugins.clipboard.dragStartContainerChildCount, delete CKEDITOR.plugins.clipboard.dragEndContainerChildCount,
c.data.dataTransfer.setData("text/html", b.editable().getHtmlFromRange(g).getHtml()), b.widgets.destroy(e, !0)
}); b.on("contentDom", function () {
    var d = b.editable(); CKEDITOR.tools.extend(a, { finder: new c.finder(b, { lookups: { "default": function (b) {
        if (!b.is(CKEDITOR.dtd.$listItem) && b.is(CKEDITOR.dtd.$block) && !h.isDomNestedEditable(b) && !a._.draggedWidget.wrapper.contains(b)) {
            var c = h.getNestedEditable(d, b); if (c) {
                b = a._.draggedWidget; if (a.getByElement(c) == b) return; c = CKEDITOR.filter.instances[c.data("cke-filter")];
            ...
            var b = a.editor; b.on("contentDom", function () {
                var c = b.editable(), d = c.isInline() ? c : b.document, e, f; c.attachListener(d, "mousedown", function (b) {
                    var c = b.data.getTarget(); if (!c.type) return !1;
                    e = a.getByElement(c); f = 0; e && (e.inline && c.type == CKEDITOR.NODE_ELEMENT && c.hasAttribute("data-cke-widget-drag-handler") ? f = 1 : h.getNestedEditable(e.wrapper, c) ? e = null : (b.data.preventDefault(), CKEDITOR.env.ie || e.focus()))
...
d = e[0], e = !(1 == e.length && d.collapsed && d.checkBoundaryOfElement(b, CKEDITOR[8 == c ? "START" : "END"]))) : e = void 0); return e
            }, null, null, 1)
        } function J(a) { function b(b) { a.focused && v(a.focused, "cut" == b.name) } var c = a.editor; c.on("contentDom", function () { var a = c.editable(); a.attachListener(a, "copy", b); a.attachListener(a, "cut", b) }) } function F(a) {
...
c.data.selection.getStartElement())) && a.getByElement(c), e = a.widgetHoldingFocusedEditable; if (e) { if (e !== d || !e.focusedEditable.equals(c)) m(a, e, null), d && c && m(a, d, c) } else d && c && m(a, d, c)
            }); b.on("dataReady", function () { w(a).commit() }); b.on("blur", function () { var b; (b = a.focused) && q(a, b); (b = a.widgetHoldingFocusedEditable) && m(a, b, null) })
        } function D(a) {
            var b = a.editor, c = {}; b.on("toDataFormat", function (b) {
                var e = CKEDITOR.tools.getNextNumber(), f = []; b.data.downcastingSessionId = e; c[e] = f; b.data.dataValue.forEach(function (b) {
                    var c =
b.attributes, d; if ("data-cke-widget-id" in c) { if (c = a.instances[c["data-cke-widget-id"]]) d = b.getFirst(h.isParserWidgetElement), f.push({ wrapper: b, element: d, widget: c, editables: {} }), "1" != d.attributes["data-cke-widget-keep-attr"] && delete d.attributes["data-widget"] } else if ("data-cke-widget-editable" in c) return f[f.length - 1].editables[c["data-cke-widget-editable"]] = b, !1
                }, CKEDITOR.NODE_ELEMENT, !0)
            }, null, null, 8); b.on("toDataFormat", function (a) {
                if (a.data.downcastingSessionId) for (var a = c[a.data.downcastingSessionId],
b, f, g, j, h, l; b = a.shift(); ) { f = b.widget; g = b.element; j = f._.downcastFn && f._.downcastFn.call(f, g); for (l in b.editables) h = b.editables[l], delete h.attributes.contenteditable, h.setHtml(f.editables[l].getData()); j || (j = g); b.wrapper.replaceWith(j) } 
            }, null, null, 13); b.on("contentDomUnload", function () { a.destroyAll(!0) })
        } function C(a) {
            var b = a.editor, c, d; b.on("toHtml", function (b) {
                var d = O(a), g; for (b.data.dataValue.forEach(d.iterator, CKEDITOR.NODE_ELEMENT, !0); g = d.toBeWrapped.pop(); ) {
                    var j = g[0], i = j.parent; i.type == CKEDITOR.NODE_ELEMENT &&
i.attributes["data-cke-widget-wrapper"] && i.replaceWith(j); a.wrapElement(g[0], g[1])
                ...
                if (d) for (var c = b.editable().find(".cke_widget_wrapper"), f, g, j = 0, i = c.count(); j < i; ++j) f = c.getItem(j), g = f.getFirst(h.isDomWidgetElement), g.type == CKEDITOR.NODE_ELEMENT &&
g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove(); d = 0; a.destroyAll(!0); a.initOnAll()
            }); b.on("loadSnapshot", function (b) { /data-cke-widget/.test(b.data) && (d = 1); a.destroyAll(!0) }, null, null, 9); b.on("paste", function (a) { a = a.data; a.dataValue = a.dataValue.replace(R, Q); if (a.range && (a = h.getNestedEditable(b.editable(), a.range.startContainer))) (a = CKEDITOR.filter.instances[a.data("cke-filter")]) && b.setActiveFilter(a) }); b.on("afterInsertHtml", function (d) {
...
(b.fire("lockSnapshot"), a.checkWidgets({ initOnlyNew: !0, focusInited: c }), b.fire("unlockSnapshot"))
            ...
            var b = a.selected, c = [], d = b.slice(0), e = null; return { select: function (a) { 0 > CKEDITOR.tools.indexOf(b, a) && c.push(a); a = CKEDITOR.tools.indexOf(d, a); 0 <= a && d.splice(a, 1); return this }, focus: function (a) { e = a; return this }, commit: function () {
                var f = a.focused !== e, g, h; a.editor.fire("lockSnapshot"); for (f && (g = a.focused) && q(a, g); g = d.pop(); ) b.splice(CKEDITOR.tools.indexOf(b, g), 1), g.isInited() && (h = g.editor.checkDirty(),
g.setSelected(!1), !h && g.editor.resetDirty()); f && e && (h = a.editor.checkDirty(), a.focused = e, a.fire("widgetFocused", { widget: e }), e.setFocused(!0), !h && a.editor.resetDirty()); for (; g = c.pop(); ) b.push(g), g.setSelected(!0); a.editor.fire("unlockSnapshot")
        ...
        } function x(a, b, c) { var d = 0, b = y(b), e = a.data.classes || {}, f; if (b) { for (e = CKEDITOR.tools.clone(e); f = b.pop(); ) c ? e[f] || (d = e[f] = 1) : e[f] && (delete e[f], d = 1); d && a.setData("classes", e) } } function z(a) { a.cancel() } function v(a, b) {
...
g = f.editable(), h = [], i = []; this.repository._.draggedWidget = this; var l = c.greedySearch(), k = CKEDITOR.tools.eventsBuffer(50, function () { m = d.locate(l); i = d.sort(n, 1); i.length && (e.prepare(l, m), e.placeLine(i[0]), e.cleanup()) }), m, n; g.addClass("cke_widget_dragging"); h.push(g.on("mousemove", function (a) { n = a.data.$.clientY; k.input() })); f.fire("dragstart", { target: a.sender }); h.push(f.document.once("mouseup", b, this)); g.isInline() || h.push(CKEDITOR.document.once("mouseup", b, this))
            ...
            a.editables = {}; if (a.editables) for (b in d) c = d[b], a.initEditable(b, "string" == typeof c ? { selector: c} : c)
        } function W(a) { if (a.mask) { var b = a.wrapper.findOne(".cke_widget_mask"); b || (b = new CKEDITOR.dom.element("img", a.editor.document), b.setAttributes({ src: CKEDITOR.tools.transparentImageData, "class": "cke_reset cke_widget_mask" }), a.wrapper.append(b)); a.mask = b } } function X(a) { if (a.parts) { var b = {}, c, d; for (d in a.parts) c = a.wrapper.findOne(a.parts[d]), b[d] = c; a.parts = b } } function K(a, b) {
            Y(a); X(a); V(a); W(a); T(a); S(a);
...
function (b) { a.edit() && b.cancel() }); if (b.data) a.on("data", b.data); if (b.edit) a.on("edit", b.edit)
        } function Y(a) { (a.wrapper = a.element.getParent()).setAttribute("data-cke-widget-id", a.id) } function p(a) { a.element.data("cke-widget-data", encodeURIComponent(JSON.stringify(a.data))) } var k = 15; CKEDITOR.plugins.add("widget", { requires: "lineutils,clipboard", onLoad: function () {
...
new n(a)
            ...
            checkSelection: function () { var a = this.editor.getSelection(), b = a.getSelectedElement(), c = w(this), d; if (b && (d = this.getByElement(b, !0))) return c.focus(d).select(d).commit(); a = a.getRanges()[0]; if (!a || a.collapsed) return c.commit(); a = new CKEDITOR.dom.walker(a); for (a.evaluator = h.isDomWidgetWrapper; b = a.next(); ) c.select(this.getByElement(b)); c.commit() }, checkWidgets: function (a) { this.fire("checkWidgets", CKEDITOR.tools.copy(a || {})) }, del: function (a) {
                if (this.focused === a) {
                    var b = a.editor, c = b.createRange(), d; if (!(d =
c.moveToClosestEditablePosition(a.wrapper, !0))) d = c.moveToClosestEditablePosition(a.wrapper, !1); d && b.getSelection().selectRanges([c])
                } a.wrapper.remove(); this.destroy(a, !0)
            }, destroy: function (a, b) { this.widgetHoldingFocusedEditable === a && m(this, a, null, b); a.destroy(b); delete this.instances[a.id]; this.fire("instanceDestroyed", a) }, destroyAll: function (a, b) {
                var c, d, e = this.instances; if (b && !a) { d = b.find(".cke_widget_wrapper"); for (var e = d.count(), f = 0; f < e; ++f) (c = this.getByElement(d.getItem(f), !0)) && this.destroy(c) } else for (d in e) c =
e[d], this.destroy(c, a)
            }, finalizeCreation: function (a) { if ((a = a.getFirst()) && h.isDomWidgetWrapper(a)) this.editor.insertElement(a), a = this.getByElement(a), a.ready = !0, a.fire("ready"), a.focus() }, getByElement: function () { var a = { div: 1, span: 1 }; return function (b, c) { if (!b) return null; var d = b.is(a) && b.data("cke-widget-id"); if (!c && !d) { var e = this.editor.editable(); do b = b.getParent(); while (b && !b.equals(e) && !(d = b.is(a) && b.data("cke-widget-id"))) } return this.instances[d] || null } } (), initOn: function (a, b, c) {
                b ? "string" ==
typeof b && (b = this.registered[b]) : b = this.registered[a.data("widget")]; if (!b) return null; var d = this.wrapElement(a, b.name); return d ? d.hasClass("cke_widget_new") ? (a = new h(this, this._.nextId++, a, b, c), a.isInited() ? this.instances[a.id] = a : null) : this.getByElement(a) : null
            }, initOnAll: function (a) { for (var a = (a || this.editor.editable()).find(".cke_widget_new"), b = [], c, d = a.count(); d--; ) (c = this.initOn(a.getItem(d).getFirst(h.isDomWidgetElement))) && b.push(c); return b }, onWidget: function (a) {
                var b = Array.prototype.slice.call(arguments);
                b.shift(); for (var c in this.instances) { var d = this.instances[c]; d.name == a && d.on.apply(d, b) } this.on("instanceCreated", function (c) { c = c.data; c.name == a && c.on.apply(c, b) })
            }, parseElementClasses: function (a) { if (!a) return null; for (var a = CKEDITOR.tools.trim(a).split(/\s+/), b, c = {}, d = 0; b = a.pop(); )-1 == b.indexOf("cke_") && (c[b] = d = 1); return d ? c : null }, wrapElement: function (a, b) {
                var c = null, d, e; if (a instanceof CKEDITOR.dom.element) {
                    d = this.registered[b || a.data("widget")]; if (!d) return null; if ((c = a.getParent()) && c.type ==
CKEDITOR.NODE_ELEMENT && c.data("cke-widget-wrapper")) return c; a.hasAttribute("data-cke-widget-keep-attr") || a.data("cke-widget-keep-attr", a.data("widget") ? 1 : 0); b && a.data("widget", b); e = u(d, a.getName()); c = new CKEDITOR.dom.element(e ? "span" : "div"); c.setAttributes(s(e)); c.data("cke-display-name", d.pathName ? d.pathName : a.getName()); a.getParent(!0) && c.replace(a); a.appendTo(c)
                } else if (a instanceof CKEDITOR.htmlParser.element) {
                    d = this.registered[b || a.attributes["data-widget"]]; if (!d) return null; if ((c = a.parent) &&
c.type == CKEDITOR.NODE_ELEMENT && c.attributes["data-cke-widget-wrapper"]) return c; "data-cke-widget-keep-attr" in a.attributes || (a.attributes["data-cke-widget-keep-attr"] = a.attributes["data-widget"] ? 1 : 0); b && (a.attributes["data-widget"] = b); e = u(d, a.name); c = new CKEDITOR.htmlParser.element(e ? "span" : "div", s(e)); c.attributes["data-cke-display-name"] = d.pathName ? d.pathName : a.name; d = a.parent; var f; d && (f = a.getIndex(), a.remove()); c.add(a); d && t(d, f, c)
        ...
        h.prototype = { addClass: function (a) { this.element.addClass(a) }, applyStyle: function (a) { x(this, a, 1) }, checkStyleActive: function (a) { var a = y(a), b; if (!a) return !1; for (; b = a.pop(); ) if (!this.hasClass(b)) return !1; return !0 }, destroy: function (a) {
            this.fire("destroy"); if (this.editables) for (var b in this.editables) this.destroyEditable(b, a); a || ("0" == this.element.data("cke-widget-keep-attr") && this.element.removeAttribute("data-widget"), this.element.removeAttributes(["data-cke-widget-data", "data-cke-widget-keep-attr"]),
this.element.removeClass("cke_widget_element"), this.element.replace(this.wrapper)); this.wrapper = null
        }, destroyEditable: function (a, b) { var c = this.editables[a]; c.removeListener("focus", B); c.removeListener("blur", A); this.editor.focusManager.remove(c); b || (this.repository.destroyAll(!1, c), c.removeClass("cke_widget_editable"), c.removeClass("cke_widget_editable_focused"), c.removeAttributes(["contenteditable", "data-cke-widget-editable", "data-cke-enter-mode"])); delete this.editables[a] }, edit: function () {
            var a =
...
b.pathName), this.editor.focusManager.add(c), c.on("focus", B, this), CKEDITOR.env.ie && c.on("blur", A, this), c._.initialSetData = !0, c.setData(c.getHtml()), !0) : !1
            }, _findOneNotNested: function (a) { for (var a = this.wrapper.find(a), b, c, d = 0; d < a.count(); d++) if (b = a.getItem(d), c = b.getAscendant(h.isDomWidgetWrapper), this.wrapper.equals(c)) return b; return null }, isInited: function () { return !(!this.wrapper || !this.inited) }, isReady: function () { return this.isInited() && this.ready }, focus: function () {
            ...
            }, removeClass: function (a) { this.element.removeClass(a) }, removeStyle: function (a) { x(this, a, 0) }, setData: function (a, b) { var c = this.data, d = 0; if ("string" == typeof a) c[a] !== b && (c[a] = b, d = 1); else { var e = a; for (a in e) c[a] !== e[a] && (d = 1, c[a] = e[a]) } d && this.dataReady && (p(this), this.fire("data", c)); return this }, setFocused: function (a) {
                this.wrapper[a ? "addClass" : "removeClass"]("cke_widget_focused"); this.fire(a ? "focus" :
"blur"); return this
                ...
                var a = this.editor, b = this.element.$, c = this._.dragHandlerOffset, b = { x: b.offsetLeft, y: b.offsetTop - k }; if (!c || !(b.x == c.x && b.y == c.y)) c = a.checkDirty(), a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({ top: b.y + "px", left: b.x + "px", display: "block" }), a.fire("unlockSnapshot"), !c && a.resetDirty(), this._.dragHandlerOffset =
b
            } 
...
"i"), Z = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 }; (function () {
    function a() { } function b(a, b, e) { return !e || !this.checkElement(a) ? !1 : (a = e.widgets.getByElement(a, !0)) && a.checkStyleActive(this) } CKEDITOR.style.addCustomHandler({ type: "widget", setup: function (a) { this.widget = a.widget }, apply: function (a) { a instanceof CKEDITOR.editor && this.checkApplicable(a.elementPath(), a) && a.widgets.focused.applyStyle(this) }, remove: function (a) { a instanceof CKEDITOR.editor && this.checkApplicable(a.elementPath(), a) && a.widgets.focused.removeStyle(this) },
        checkActive: function (a, b) { return this.checkElementMatch(a.lastElement, 0, b) }, checkApplicable: function (a, b) { return !(b instanceof CKEDITOR.editor) ? !1 : this.checkElement(a.lastElement) }, checkElementMatch: b, checkElementRemovable: b, checkElement: function (a) { return !h.isDomWidgetWrapper(a) ? !1 : (a = a.getFirst(h.isDomWidgetElement)) && a.data("widget") == this.widget }, buildPreview: function (a) { return a || this._.definition.name }, toAllowedContentRules: function (a) {
            if (!a) return null; var a = a.widgets.registered[this.widget],
b, e = {}; if (!a) return null; if (a.styleableElements) { b = this.getClassesArray(); if (!b) return null; e[a.styleableElements] = { classes: b, propertiesOnly: !0 }; return e } return a.styleToAllowedContentRules ? a.styleToAllowedContentRules(this) : null
...
})(); CKEDITOR.plugins.widget = h; h.repository = n; h.nestedEditable = o
    })(); (function () {
        CKEDITOR.plugins.add("chart", { requires: "widget,dialog", icons: "chart", lang: "en,pl", afterInit: function () { var a = this; "undefined" === typeof Chart && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(a.path + "lib/chart.min.js"), function () { a.drawCharts() }) }, init: function (a) {
            var l = this, n = a.config.chart_height || 300, g = a.config.chart_colors || { fillColor: "rgba(151,187,205,0.5)", strokeColor: "rgba(151,187,205,0.8)", highlightFill: "rgba(151,187,205,0.75)", highlightStroke: "rgba(151,187,205,1)", data: "#B33131 #B66F2D #B6B330 #71B232 #33B22D #31B272 #2DB5B5 #3172B6 #3232B6 #6E31B2 #B434AF #B53071".split(" ") },
i = { Bar: a.config.chart_configBar || { animation: !1 }, Doughnut: a.config.chart_configDoughnut || { animateRotate: !1 }, Line: a.config.chart_configLine || { animation: !1 }, Pie: a.config.chart_configPie || { animateRotate: !1 }, PolarArea: a.config.chart_configPolarArea || { animateRotate: !1} }, m = a.config.chart_maxItems || 8; a.addContentsCss(CKEDITOR.getUrl(l.path + "chart.css")); a.on("contentPreview", function (b) {
    b.data.dataValue = b.data.dataValue.replace(/<\/head>/, '<script>var chartjs_colors_json = "' + JSON.stringify(g).replace(/\"/g,
'\\"') + '";<\/script><script>var chartjs_config_json = "' + JSON.stringify(i).replace(/\"/g, '\\"') + '";<\/script><script src="' + CKEDITOR.getUrl(l.path + "lib/chart.min.js") + '"><\/script><script src="' + CKEDITOR.getUrl(l.path + "widget2chart.js") + '"><\/script></head>')
}); CKEDITOR.dialog.add("chart", function (b) {
    for (var a = { title: b.lang.chart.dialogTitle, minWidth: 200, minHeight: 100, onShow: function () {
        var k = b.widgets.focused; if (k) for (var a = 0; a < m; a++) k.data.values[a] && (this.setValueOf("data", "value" + a, k.data.values[a].value.toString()),
this.setValueOf("data", "label" + a, k.data.values[a].label))
    }, onOk: function () { for (var b = this.widget, a = [], d, c = 0; c < m; c++) (d = this.getValueOf("data", "value" + c)) && a.push({ value: parseFloat(this.getValueOf("data", "value" + c)), label: this.getValueOf("data", "label" + c) }); b.setData("values", a); b.setData("chart", this.getValueOf("data", "chart")); b.setData("height", this.getValueOf("data", "height")) }, contents: [{ id: "data", elements: [{ type: "hbox", children: [{ id: "chart", type: "select", label: b.lang.chart.chartType, labelLayout: "horizontal",
        labelStyle: "display:block;padding: 4px 6px;", items: [[b.lang.chart.bar, "bar"], [b.lang.chart.line, "line"], [b.lang.chart.pie, "pie"], [b.lang.chart.polar, "polar"], [b.lang.chart.doughnut, "doughnut"]], style: "margin-bottom:10px", setup: function (b) { this.setValue(b.data.chart) } 
    }, { id: "height", type: "text", label: b.lang.chart.height, labelLayout: "horizontal", labelStyle: "display:block;padding: 4px 6px;", width: "50px", setup: function (b) { this.setValue(b.data.height) }, validate: function () {
        var a = this.getValue(), a = !a || !!(CKEDITOR.dialog.validate.number(a) &&
0 <= a); a || (alert(b.lang.common.validateNumberFailed), this.select()); return a
    } 
    }]
    }]
    }]
    }, d = 0; d < m; d++) a.contents[0].elements.push({ type: "hbox", children: [{ id: "value" + d, type: "text", labelLayout: "horizontal", label: b.lang.chart.value, labelStyle: "display:block;padding: 4px 6px;", width: "50px", validate: function () { var a = this.getValue(), a = !a || !!(CKEDITOR.dialog.validate.number(a) && 0 <= a); a || (alert(b.lang.common.validateNumberFailed), this.select()); return a } }, { id: "label" + d, type: "text", label: b.lang.chart.label, labelLayout: "horizontal",
        labelStyle: "display:block;padding: 4px 6px;", width: "200px"
    }]
    }); return a
}); this.drawCharts = function () { for (var b in a.widgets.instances) "chart" == a.widgets.instances[b].name && a.widgets.instances[b].fire("data") }; a.widgets.add("chart", { button: a.lang.chart.chart, dialog: "chart", template: '<div class="chartjs" data-chart="bar" data-chart-height="' + n + '"><canvas height="' + n + '"></canvas><div class="chartjs-legend"></div></div>', styleableElements: "div", pathName: "chart", init: function () {
    this.element.data("chart-value") &&
this.setData("values", JSON.parse(this.element.data("chart-value"))); this.setData("chart", this.element.data("chart")); this.setData("height", this.element.data("chart-height")); this.on("dialog", function (a) { a.data.widget = this }, this)
}, data: function () {
    if ("undefined" !== typeof Chart && this.data.values) {
        var b = a.document.createElement("canvas", { attributes: { height: this.data.height} }); b.replace(this.element.getChild(0)); var f = this.element.getChild(1).$, b = b.$; if (b.getContext) {
            var d = this.data; setTimeout(function () {
                var a =
d, e = a.values, h = a.chart, c; c = b.getContext("2d"); var j = new Chart(c); if ("bar" != h) for (c = 0; c < e.length; c++) e[c].color = g.data[c], e[c].highlight = g.data[c]; if ("bar" == h || "line" == h) { a = { datasets: [{ label: "", fillColor: g.fillColor, strokeColor: g.strokeColor, highlightFill: g.highlightFill, highlightStroke: g.highlightStroke, data: []}], labels: [] }; for (c = 0; c < e.length; c++) e[c].value && (a.labels.push(e[c].label), a.datasets[0].data.push(e[c].value)); f.innerHTML = "" } "bar" == h ? j.Bar(a, i.Bar) : "line" == h ? j.Line(a, i.Line) : f.innerHTML =
"polar" == h ? j.PolarArea(e, i.PolarArea).generateLegend() : "pie" == h ? j.Pie(e, i.Pie).generateLegend() : j.Doughnut(e, i.Doughnut).generateLegend()
            }, 0)
        } 
    } 
    ...
    if ("div" == a.name && a.hasClass("chartjs")) {
        a.setHtml(""); var f = new CKEDITOR.htmlParser.element("canvas", { height: a.attributes["data-chart-height"] }); a.add(f); f = new CKEDITOR.htmlParser.element("div", { "class": "chartjs-legend" });
        a.add(f); return a
    } 
...
(this.widget.focus(), delete this.focused), delete this.deflated; else { var b = this.widget, d = f, c = b.wrapper, e = b.data.align, b = b.data.hasCaption; if (d) { for (var j = 3; j--; ) c.removeClass(d[j]); "center" == e ? b && c.addClass(d[1]) : "none" != e && c.addClass(d[n[e]]) } else "center" == e ? (b ? c.setStyle("text-align", "center") : c.removeStyle("text-align"), c.removeStyle("float")) : ("none" == e ? c.removeStyle("float") : c.setStyle("float", e), c.removeStyle("text-align")) } 
            ...
            return { allowedContent: B(a), requiredContent: "img[src,alt]", features: C(a), styleableElements: "img figure", contentTransformations: [["img[width]: sizeToAttribute"]], editables: { caption: { selector: "figcaption", allowedContent: "br em strong sub sup u s; a[!href]"} }, parts: { image: "img", caption: "figcaption" }, dialog: "image2", template: z, data: function () {
                var d = this.features; this.data.hasCaption && !a.filter.checkFeature(d.caption) && (this.data.hasCaption = !1); "none" != this.data.align && !a.filter.checkFeature(d.align) &&
(this.data.align = "none"); this.shiftState({ widget: this, element: this.element, oldData: this.oldData, newData: this.data, deflate: b, inflate: e }); this.data.link ? this.parts.link || (this.parts.link = this.parts.image.getParent()) : this.parts.link && delete this.parts.link; this.parts.image.setAttributes({ src: this.data.src, "data-cke-saved-src": this.data.src, alt: this.data.alt }); if (this.oldData && !this.oldData.hasCaption && this.data.hasCaption) for (var c in this.data.classes) this.parts.image.removeClass(c); if (a.filter.checkFeature(d.dimension)) {
                    d =
this.data; d = { width: d.width, height: d.height }; c = this.parts.image; for (var f in d) d[f] ? c.setAttribute(f, d[f]) : c.removeAttribute(f)
                } this.oldData = CKEDITOR.tools.extend({}, this.data)
            }, init: function () {
                var b = CKEDITOR.plugins.image2, c = this.parts.image, e = { hasCaption: !!this.parts.caption, src: c.getAttribute("src"), alt: c.getAttribute("alt") || "", width: c.getAttribute("width") || "", height: c.getAttribute("height") || "", lock: this.ready ? b.checkHasNaturalRatio(c) : !0 }, g = c.getAscendant("a"); g && this.wrapper.contains(g) && (this.parts.link =
g); e.align || (c = e.hasCaption ? this.element : c, f ? (c.hasClass(f[0]) ? e.align = "left" : c.hasClass(f[2]) && (e.align = "right"), e.align ? c.removeClass(f[n[e.align]]) : e.align = "none") : (e.align = c.getStyle("float") || "none", c.removeStyle("float"))); if (a.plugins.link && this.parts.link && (e.link = CKEDITOR.plugins.link.parseLinkAttributes(a, this.parts.link), (c = e.link.advanced) && c.advCSSClasses)) c.advCSSClasses = CKEDITOR.tools.trim(c.advCSSClasses.replace(/cke_\S+/, "")); this.wrapper[(e.hasCaption ? "remove" : "add") + "Class"]("cke_image_nocaption");
                this.setData(e); a.filter.checkFeature(this.features.dimension) && !0 !== a.config.image2_disableResizer && D(this); this.shiftState = b.stateShifter(this.editor); this.on("contextMenu", function (a) { a.data.image = CKEDITOR.TRISTATE_OFF; if (this.parts.link || this.wrapper.getAscendant("a")) a.data.link = a.data.unlink = CKEDITOR.TRISTATE_OFF }); this.on("dialog", function (a) { a.data.widget = this }, this)
            }, addClass: function (a) { k(this).addClass(a) }, hasClass: function (a) { return k(this).hasClass(a) }, removeClass: function (a) { k(this).removeClass(a) },
                getClasses: function () { var a = RegExp("^(" + [].concat(g, f).join("|") + ")$"); return function () { var b = this.repository.parseElementClasses(k(this).getAttribute("class")), e; for (e in b) a.test(e) && delete b[e]; return b } } (), upcast: E(a), downcast: F(a)
            }
        } function E(a) {
            var b = l(a), e = a.config.image2_captionedClass; return function (a, g) {
                var d = { width: 1, height: 1 }, c = a.name, h; if (!a.attributes["data-cke-realelement"]) {
                    if (b(a)) {
                        if ("div" == c && (h = a.getFirst("figure"))) a.replaceWith(h), a = h; g.align = "center"; h = a.getFirst("img") ||
a.getFirst("a").getFirst("img")
                    } else "figure" == c && a.hasClass(e) ? h = a.getFirst("img") || a.getFirst("a").getFirst("img") : o(a) && (h = "a" == a.name ? a.children[0] : a); if (h) { for (var y in d) (c = h.attributes[y]) && c.match(G) && delete h.attributes[y]; return a } 
                } 
            } 
        } function F(a) {
            var b = a.config.image2_alignClasses; return function (a) {
                var f = "a" == a.name ? a.getFirst() : a, g = f.attributes, d = this.data.align; if (!this.inline) { var c = a.getFirst("span"); c && c.replaceWith(c.getFirst({ img: 1, a: 1 })) } d && "none" != d && (c = CKEDITOR.tools.parseCssText(g.style ||
""), "center" == d && "figure" == a.name ? a = a.wrapWith(new CKEDITOR.htmlParser.element("div", b ? { "class": b[1]} : { style: "text-align:center" })) : d in { left: 1, right: 1} && (b ? f.addClass(b[n[d]]) : c["float"] = d), !b && !CKEDITOR.tools.isEmpty(c) && (g.style = CKEDITOR.tools.writeCssText(c))); return a
            } 
        } function l(a) {
            var b = a.config.image2_captionedClass, e = a.config.image2_alignClasses, f = { figure: 1, a: 1, img: 1 }; return function (g) {
                if (!(g.name in { div: 1, p: 1 })) return !1; var d = g.children; if (1 !== d.length) return !1; d = d[0]; if (!(d.name in f)) return !1;
                if ("p" == g.name) { if (!o(d)) return !1 } else if ("figure" == d.name) { if (!d.hasClass(b)) return !1 } else if (a.enterMode == CKEDITOR.ENTER_P || !o(d)) return !1; return (e ? g.hasClass(e[1]) : "center" == CKEDITOR.tools.parseCssText(g.attributes.style || "", !0)["text-align"]) ? !0 : !1
            } 
        } function o(a) { return "img" == a.name ? !0 : "a" == a.name ? 1 == a.children.length && a.getFirst("img") : !1 } function D(a) {
            var b = a.editor, e = b.editable(), f = b.document, g = a.resizer = f.createElement("span"); g.addClass("cke_image_resizer"); g.setAttribute("title", b.lang.image2.resizer);
            g.append(new CKEDITOR.dom.text("​", f)); if (a.inline) a.wrapper.append(g); else { var d = a.parts.link || a.parts.image, c = d.getParent(), h = f.createElement("span"); h.addClass("cke_image_resizer_wrapper"); h.append(d); h.append(g); a.element.append(h, !0); c.is("span") && c.remove() } g.on("mousedown", function (c) {
                function j(a, b, c) { var d = CKEDITOR.document, j = []; f.equals(d) || j.push(d.on(a, b)); j.push(f.on(a, b)); if (c) for (a = j.length; a--; ) c.push(j.pop()) } function d() { p = k + w * t; q = Math.round(p / r) } function s() {
                    q = n - m; p = Math.round(q *
r)
                } var h = a.parts.image, w = "right" == a.data.align ? -1 : 1, i = c.data.$.screenX, H = c.data.$.screenY, k = h.$.clientWidth, n = h.$.clientHeight, r = k / n, l = [], o = "cke_image_s" + (! ~w ? "w" : "e"), x, p, q, v, t, m, u; b.fire("saveSnapshot"); j("mousemove", function (a) { x = a.data.$; t = x.screenX - i; m = H - x.screenY; u = Math.abs(t / m); 1 == w ? 0 >= t ? 0 >= m ? d() : u >= r ? d() : s() : 0 >= m ? u >= r ? s() : d() : s() : 0 >= t ? 0 >= m ? u >= r ? s() : d() : s() : 0 >= m ? d() : u >= r ? d() : s(); 15 <= p && 15 <= q ? (h.setAttributes({ width: p, height: q }), v = !0) : v = !1 }, l); j("mouseup", function () {
                    for (var c; c = l.pop(); ) c.removeListener();
                    e.removeClass(o); g.removeClass("cke_image_resizing"); v && (a.setData({ width: p, height: q }), b.fire("saveSnapshot")); v = !1
                }, l); e.addClass(o); g.addClass("cke_image_resizing")
            }); a.on("data", function () { g["right" == a.data.align ? "addClass" : "removeClass"]("cke_image_resizer_left") })
        } function I(a) {
            var b = [], e; return function (f) {
                var g = a.getCommand("justify" + f); if (g) {
                    b.push(function () { g.refresh(a, a.elementPath()) }); if (f in { right: 1, left: 1, center: 1 }) g.on("exec", function (d) {
                        var c = i(a); if (c) {
                            c.setData("align", f); for (c =
b.length; c--; ) b[c](); d.cancel()
                        } 
                    }); g.on("refresh", function (b) { var c = i(a), g = { right: 1, left: 1, center: 1 }; c && (void 0 === e && (e = a.filter.checkFeature(a.widgets.registered.image.features.align)), e ? this.setState(c.data.align == f ? CKEDITOR.TRISTATE_ON : f in g ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) : this.setState(CKEDITOR.TRISTATE_DISABLED), b.cancel()) })
                } 
            } 
        } function J(a) {
            a.plugins.link && (CKEDITOR.on("dialogDefinition", function (b) {
                b = b.data; if ("link" == b.name) {
                    var b = b.definition, e = b.onShow, f = b.onOk; b.onShow =
function () { var b = i(a); b && (b.inline ? !b.wrapper.getAscendant("a") : 1) ? this.setupContent(b.data.link || {}) : e.apply(this, arguments) }; b.onOk = function () { var b = i(a); if (b && (b.inline ? !b.wrapper.getAscendant("a") : 1)) { var d = {}; this.commitContent(d); b.setData("link", d) } else f.apply(this, arguments) } 
                } 
            }), a.getCommand("unlink").on("exec", function (b) { var e = i(a); e && e.parts.link && (e.setData("link", null), this.refresh(a, a.elementPath()), b.cancel()) }), a.getCommand("unlink").on("refresh", function (b) {
                var e = i(a); e && (this.setState(e.data.link ||
e.wrapper.getAscendant("a") ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), b.cancel())
            }))
        } function i(a) { return (a = a.widgets.focused) && "image" == a.name ? a : null } function B(a) {
            var b = a.config.image2_alignClasses, a = { div: { match: l(a) }, p: { match: l(a) }, img: { attributes: "!src,alt,width,height" }, figure: { classes: "!" + a.config.image2_captionedClass }, figcaption: !0 }; b ? (a.div.classes = b[1], a.p.classes = a.div.classes, a.img.classes = b[0] + "," + b[2], a.figure.classes += "," + a.img.classes) : (a.div.styles = "text-align", a.p.styles =
"text-align", a.img.styles = "float", a.figure.styles = "float,display"); return a
        } function C(a) { a = a.config.image2_alignClasses; return { dimension: { requiredContent: "img[width,height]" }, align: { requiredContent: "img" + (a ? "(" + a[0] + ")" : "{float}") }, caption: { requiredContent: "figcaption"}} } function k(a) { return a.data.hasCaption ? a.element : a.parts.image } var z = '<img alt="" src="" />', K = new CKEDITOR.template('<figure class="{captionedClass}">' + z + "<figcaption>{captionPlaceholder}</figcaption></figure>"), n = { left: 0, center: 1,
            right: 2
        }, G = /^\s*(\d+\%)\s*$/i; CKEDITOR.plugins.add("image2", { requires: "widget,dialog", icons: "image", hidpi: !0, onLoad: function () { CKEDITOR.addCss(".cke_image_nocaption{line-height:0}.cke_editable.cke_image_sw, .cke_editable.cke_image_sw *{cursor:sw-resize !important}.cke_editable.cke_image_se, .cke_editable.cke_image_se *{cursor:se-resize !important}.cke_image_resizer{display:none;position:absolute;width:10px;height:10px;bottom:-5px;right:-5px;background:#000;outline:1px solid #fff;line-height:0;cursor:se-resize;}.cke_image_resizer_wrapper{position:relative;display:inline-block;line-height:0;}.cke_image_resizer.cke_image_resizer_left{right:auto;left:-5px;cursor:sw-resize;}.cke_widget_wrapper:hover .cke_image_resizer,.cke_image_resizer.cke_image_resizing{display:block}.cke_widget_wrapper>a{display:inline-block}") },
            init: function (a) {
                var b = a.config, e = a.lang.image2, f = A(a); b.filebrowserImage2BrowseUrl = b.filebrowserImageBrowseUrl; b.filebrowserImage2UploadUrl = b.filebrowserImageUploadUrl; f.pathName = e.pathName; f.editables.caption.pathName = e.pathNameCaption; a.widgets.add("image", f); a.ui.addButton && a.ui.addButton("Image", { label: a.lang.common.image, command: "image", toolbar: "insert,10" }); a.contextMenu && (a.addMenuGroup("image", 10), a.addMenuItem("image", { label: e.menu, command: "image", group: "image" })); CKEDITOR.dialog.add("image2",
this.path + "dialogs/image2.js")
            }, afterInit: function (a) { var b = { left: 1, right: 1, center: 1, block: 1 }, e = I(a), f; for (f in b) e(f); J(a) } 
        }); CKEDITOR.plugins.image2 = { stateShifter: function (a) {
...
e)
            ...
            } var f = a.document, g = a.config.image2_alignClasses, d = a.config.image2_captionedClass, c = a.editable(), h = ["hasCaption", "align", "link"], i = { align: function (c, d, e) {
                var f = c.element; if (c.changed.align) { if (!c.newData.hasCaption && ("center" == e && (c.deflate(), c.element = b(a, f)), !c.changed.hasCaption && "center" == d && "center" != e)) c.deflate(), d = f.findOne("a,img"), d.replace(f), c.element = d } else "center" == e && (c.changed.hasCaption && !c.newData.hasCaption) && (c.deflate(), c.element = b(a, f)); !g && f.is("figure") &&
...
a.match(/"data:image\/png;base64,(.*?)"/)[1], f = CKEDITOR.tools.getNextId(), b = d.config.filebrowserImageUploadUrl, b = b.indexOf("?") == -1 ? b + "?" : b + "&", b = b + ("CKEditor=" + d.name + "&CKEditorFuncNum=2&langCode=" + d.langCode), e = new XMLHttpRequest; e.open("POST", b); e.onload = function () { var a = e.responseText.match(/2,\s*'(.*?)',/)[1], b = d.document.getById(f); b.data("cke-saved-src", a); b.setAttribute("src", a); b.removeAttribute("id") }; b = '-----------------------------1966284435497298061834782736\r\nContent-Disposition: form-data; name="upload"';
            c = window.atob(c); b = b + ('; filename="' + f + '.png"\r\nContent-type: image/png') + ("\r\n\r\n" + c + "\r\n-----------------------------1966284435497298061834782736") + "--"; e.setRequestHeader("Content-Type", "multipart/form-data; boundary=---------------------------1966284435497298061834782736"); e.sendAsBinary(b); return a.replace(/>/, ' id="' + f + '">')
        }), c.data.html ? c.data.html = a : c.data.dataValue = a
    })
} 
}); CKEDITOR.plugins.add("imageresize", { init: function (a) {
    if (this.support()) {
...
this.ckeditorimageresize.h + "px"
...
}, supportResult: null, support: function () { if (null === this.supportResult) { this.supportResult = !1; var a = document.createElement("canvas"); if (a && a.getContext && a.toDataURL && a.getContext("2d") && (a = a.getContext("2d")) && a.getImageData && a.putImageData) this.supportResult = !0 } return this.supportResult }, config: { maxWidth: 800,
    maxHeight: 800
    ...
    function f(b, d) {
        var a = b.getSelection().getStartElement().getAscendant("img", !0); if (a) if (a = a.$) {
            "crossOrigin" in a && a.setAttribute("crossOrigin", "anonymous"); try {
                var c = d, c = 0 > c ? 360 + c : c, g = a.width, h = a.height; if (90 == c || 270 == c) g = a.height, h = a.width; var f = g / 2, m = h / 2, j = a.width, k = a.height, e = document.createElement("canvas"); e.width = g; e.height = h; var i = e.getContext("2d"); i.translate(f, m); i.rotate(c * n); i.drawImage(a, -j / 2, -k / 2, j, k); var l = e.toDataURL(); a.src = l; a.setAttribute("data-cke-saved-src", l); a.style.width =
e.width + "px"; a.style.height = e.height + "px"
            } catch (o) { 18 === o.code && b.showNotification("Image is from other domain and can't be rotated", "warning") } 
        } else b.showNotification("no DOM image element?", "warning"); else b.showNotification("no image element?", "warning")
    } var n = Math.PI / 180; CKEDITOR.plugins.add("imagerotate", { lang: "en,et", hidpi: !0, icons: "rotate-left.png,rotate-right.png", init: function (b) {
        b.addCommand("rotateLeft", { exec: function (a) { f(a, -90) } }); b.addCommand("rotateRight", { exec: function (a) { f(a, 90) } });
        var d = b.lang.imagerotate; d || (d = { rotateRight: "Rotate Clockwise", rotateLeft: "Rotate Counter-clockwise" }); b.contextMenu && (b.addMenuItems({ rotateRight: { label: d.rotateRight, icon: this.path + "icons/rotate-right.png", command: "rotateRight", group: "image", order: 1 }, rotateLeft: { label: d.rotateLeft, icon: this.path + "icons/rotate-left.png", command: "rotateLeft", group: "image", order: 2} }), b.contextMenu.addListener(function (a) { if (a.getAscendant("img", !0)) return { rotateLeft: CKEDITOR.TRISTATE_OFF, rotateRight: CKEDITOR.TRISTATE_OFF} }))
    } 
    })
})(); CKEDITOR.plugins.add("imageuploader", { init: function (a) { a.config.filebrowserUploadUrl = "ckeditor/plugins/imageuploader/imgupload.php"; a.config.filebrowserBrowseUrl = "ckeditor/plugins/imageuploader/imgbrowser.php" } }); (function () {
...
})(); CKEDITOR.plugins.add("simplebutton", { init: function (a) { a.addCommand("simplebutton", new CKEDITOR.dialogCommand("simplebuttonDialog")); a.ui.addButton("simplebutton", { label: "Simple Button", command: "simplebutton", icon: this.path + "images/simplebutton.png" }); a.on("doubleclick", function (a) { a.data.element.hasClass("simple-button-plugin") && (a.data.dialog = "simplebuttonDialog") }); CKEDITOR.dialog.add("simplebuttonDialog", this.path + "dialogs/simplebutton.js") } }); CKEDITOR.plugins.add("SimpleImage", { icons: "simpleimage", init: function (a) { a.addCommand("simpleimage", new CKEDITOR.dialogCommand("simpleimageDialog")); a.ui.addButton("SimpleImage", { label: "Add a image", icons: "simpleimage", command: "simpleimage" }); CKEDITOR.dialog.add("simpleimageDialog", this.path + "dialogs/simpleimage.js") } }); CKEDITOR.plugins.add("stat", { lang: "en,ru,fr", init: function (b) {
    function n() {
        var a = ""; if ("wysiwyg" == b.mode) a = (a = b.getSelection()) && a.getType() == CKEDITOR.SELECTION_TEXT && null !== a.getSelectedText() ? i(a.getSelectedText(), "nospace") : ""; else if (window["codemirror_" + b.id]) a = window["codemirror_" + b.id].getSelection(); else {
            a = b.textarea.$; if (document.selection) {
                var d = document.selection.createRange().getBookmark(), c = a.createTextRange(); c.moveToBookmark(d); d = a.createTextRange(); d.collapse(!0); d.setEndPoint("EndToStart",
c); a.selectionStart = d.text.length; a.selectionEnd = d.text.length + c.text.length; a.selectedText = c.text
            } else a.selectionStart && (a.selectedText = a.value.substring(a.selectionStart, a.selectionEnd)); a = a.selectedText
        } document.getElementById("cke_stat_select_" + b.name) && (document.getElementById("cke_stat_select_" + b.name).innerHTML = b.lang.stat.sel + ":" + a.replace(/[\s\n\r]/g, "").length)
    } var j = function (a) { return a.replace(/^[\s]+([^\s])/g, "$1").replace(/([^\s])[\s]+$/g, "$1") }, i = function (a, b) {
        var c = "", e = [], a = a + "",
e = a.match(/(<\/?[\S][^>]*>|&[a-z]+;)/gi); for (c in e) isNaN(c) || (a = a.split(e[c].toString()).join(" ")); return "nospace" == b ? j(a.replace(/[\s]/gi, "")) : a
    }, k = 0, g = function () {
        clearTimeout(k); k = setTimeout(function () {
            var a = b.getData() + ""; if (document.getElementById("cke_stat_word_number_" + b.name)) { var d = document.getElementById("cke_stat_word_number_" + b.name), c = b.lang.stat.words + ":", e; e = a.replace(/(\r\n|\n|\r)/gm, " ").replace(/&nbsp;/g, " "); e = j(i(e)).split(/\s+/).length; d.innerHTML = c + e } document.getElementById("cke_stat_" +
b.name) && (document.getElementById("cke_stat_" + b.name).innerHTML = b.lang.stat.strlen + ":" + i(a).length); document.getElementById("cke_stat_source_" + b.name) && (document.getElementById("cke_stat_source_" + b.name).innerHTML = b.lang.stat.source + ":" + a.length)
        }, 100)
    }; b.on("instanceReady", function () {
        var a = ["stat", "stat_select", "stat_source", "stat_without_space", "stat_word_number"], d; for (d in a) {
            var c = document.createElement("div"); c.setAttribute("id", "cke_" + a[d] + "_" + b.name); c.setAttribute("style", "float:left; line-height:23px; margin-left:10px;");
            CKEDITOR.document.getById(b.ui.spaceId("bottom")).append(new CKEDITOR.dom.node(c))
        } window.onmousemove = function () { f && h() }; window.onmouseup = function () { f = !1 }; g()
    }); var l = 0, h = function () { clearTimeout(l); l = setTimeout(n, 100) }, m = function (a) { a.data.$.shiftKey && (a = a.data.$.keyCode, 33 <= a && 40 >= a && h()) }, f = !1; b.on("mode", function () { "source" == b.mode && (b.textarea.on("keyup", m), b.textarea.on("mousedown", function () { f = !0 })) }); b.on("contentDom", function () {
        this.getCommand("cut").on("state", h); b.document.on("keyup", m);
        b.document.on("mousedown", function () { f = !0 }); b.document.on("mouseup", function () { f = !1 })
    }); b.on("selectionChange", h); b.on("key", g); b.on("afterCommandExec", g); b.on("dialogHide", g)
} 
    ...
    var SetURLtoCKeditor = function (b) { var c = CKEDITOR.dialog.getCurrent(); c.setValueOf("info", "txtUrl", b); c.setValueOf("info", "txtWidth", ""); c.setValueOf("info", "txtHeight", ""); c.setValueOf("advanced", "txtdlgGenStyle", "max-width:100%;max-height:100%") }, GenerateTabbedHTMLfromArray = function (b, c, d) {
        var a = ""; if (tabbedis_array(b)) {
            "" != d && (a += '<div id="dsbrandimages">' + d + "</div>"); for (var a = a + '<div id="dsAssetsImagesDiv" >', e = 0; e < b.length; e++) a += '<div class="dsimgandradiocontainerdiv">', a += '<label for="' + e + 'dsassets" class="dsimgcontainerdiv">',
a += '<img class="dsimageblock" src="' + c[e] + '"/>', a += "</label>", a += '<div class="dsimageradio">', a += '<input id="' + e + 'dsassets" type="radio" name="dsimagebrowserradio" value="1" onclick="SetURLtoCKeditor(\'' + b[e] + "')\">", a += "</div>", a += "</div>"; a += "</div>"
        } if ((void 0 === c || "" === c) && "" === d) a += "<div>No images available.</div>"; return a
    }, GenerateTabbedbrowserHTML = function () {
        var b = ""; return b = void 0 != CKEDITOR.config.tabbedimages && void 0 != CKEDITOR.config.tabbedthumbimages ? GenerateTabbedHTMLfromArray(CKEDITOR.config.tabbedimages,
CKEDITOR.config.tabbedthumbimages, "") : "<div>No images available.</div>"
    }, ReplaceDSbrowserHTML = function () { var b = GenerateTabbedbrowserHTML(); document.getElementById("dsbrowserfullcontainer").innerHTML = b };
    CKEDITOR.plugins.add("tabbedimagebrowser", { init: function () {
...
function () { ReplaceDSbrowserHTML() })
        })
    } 
    }); CKEDITOR.plugins.add("texttransform", { lang: "en,tr", init: function (a) {
        var c = 0; a.addCommand("transformTextSwitch", { exec: function () { var b = a.getSelection(), d = ["transformTextToUppercase", "transformTextToLowercase", "transformTextCapitalize"]; 0 < b.getSelectedText().length && (b.lock(), a.execCommand(d[c]), b.unlock(!0), c < d.length - 1 ? c++ : c = 0) } }); a.addCommand("transformTextToUppercase", { exec: function () {
            var b = a.getSelection(); 0 < b.getSelectedText().length && ("tr" == a.langCode ? a.insertHtml(b.getSelectedText().trToUpperCase()) :
a.insertHtml(b.getSelectedText().toUpperCase()))
        } 
        }); a.addCommand("transformTextToLowercase", { exec: function () { var b = a.getSelection(); 0 < b.getSelectedText().length && ("tr" == a.langCode ? a.insertHtml(b.getSelectedText().trToLowerCase()) : a.insertHtml(b.getSelectedText().toLowerCase())) } }); a.addCommand("transformTextCapitalize", { exec: function () {
            var b = a.getSelection(); 0 < b.getSelectedText().length && (b = "tr" == a.langCode ? b.getSelectedText().replace(/\w\S*/g, function (a) { return a.charAt(0).trToUpperCase() + a.substr(1).trToLowerCase() }) :
b.getSelectedText().replace(/\w\S*/g, function (a) { return a.charAt(0).toUpperCase() + a.substr(1).toLowerCase() }), a.insertHtml(b))
        } 
        }); a.ui.addButton("TransformTextSwitcher", { label: a.lang.texttransform.transformTextSwitchLabel, command: "transformTextSwitch", icon: this.path + "images/transformSwitcher.png" }); a.ui.addButton("TransformTextToLowercase", { label: a.lang.texttransform.transformTextToLowercaseLabel, command: "transformTextToLowercase", icon: this.path + "images/transformToLower.png" }); a.ui.addButton("TransformTextToUppercase",
...
0, {})); CKEDITOR.config.xdsoft_yandex_key = "trnsl.1.1.20130819T112450Z.e14ecaa487166a0d.86f8dd0967b040960bdc710ece4be7420e88ddb2"; CKEDITOR.config.xdsoft_tranlater_default_from_language = "en"; CKEDITOR.config.xdsoft_tranlater_default_to_language = "es"; CKEDITOR.config.xdsoft_ontranslate = "replace"; CKEDITOR.config.xdsoft_hotkeys = CKEDITOR.CTRL + 13; CKEDITOR.config.xdsoft_service = "yandex"; CKEDITOR.config.xdsoft_bing_client_id = ""; CKEDITOR.config.xdsoft_bing_client_secret = "";
    CKEDITOR.config.xdsoft_bing_interval_update_token = 54E4; CKEDITOR.plugins.add("tweetabletext", { icons: "tweetabletext", beforeInit: function () { }, init: function (a) {
        a.addCommand("tweetabletext", new CKEDITOR.dialogCommand("tweetabletextDialog")); a.addCommand("untweetabletext", new CKEDITOR.unlinkCommand); a.ui.addButton("TweetableText", { label: "Insert TweetableText", command: "tweetabletext", toolbar: "insert" }); a.contextMenu && (a.addMenuGroup("tweetabletextGroup"), a.addMenuItems({ tweetabletextItem: { label: "Edit TweetableText", icon: this.path + "icons/tweetabletext.png", command: "tweetabletext",
            group: "tweetabletextGroup"
        }, unTweetabletextItem: { label: "Remove TweetableText", icon: this.path + "icons/tweetabletext.png", command: "untweetabletext", group: "tweetabletextGroup"}
        }), a.contextMenu.addListener(function (a) { if ("tweetabletext" === a.getAttribute("class")) return { tweetabletextItem: CKEDITOR.TRISTATE_OFF, unTweetabletextItem: CKEDITOR.TRISTATE_OFF} })); CKEDITOR.dialog.add("tweetabletextDialog", this.path + "dialogs/tweetabletext.js"); "object" === typeof a.config.contentsCss && a.config.contentsCss.push(CKEDITOR.getUrl(this.path +
"css/tweetabletext.css"))
    } 
    }); CKEDITOR.unlinkCommand = function () { }; CKEDITOR.unlinkCommand.prototype = { exec: function (a) { var b = new CKEDITOR.style({ element: "a", type: CKEDITOR.STYLE_INLINE, alwaysRemoveElement: 1 }); a.removeStyle(b) }, refresh: function (a, b) { var c = b.lastElement && b.lastElement.getAscendant("a", !0); c && "a" === c.getName() && c.getAttribute("href") && c.getChildCount() ? this.setState(CKEDITOR.TRISTATE_OFF) : this.setState(CKEDITOR.TRISTATE_DISABLED) }, contextSensitive: 1, startDisabled: 1, requiredContent: "a[href]" }; CKEDITOR.plugins.add("wordcount", { version: 1.12, requires: "htmlwriter", init: function (c) {
        function l(f) { return document.getElementById("cke_wordcount_" + f.name) } function q(f) { var a = document.createElement("div"); a.innerHTML = f; return "" == a.textContent && "undefined" == typeof a.innerText ? "" : a.textContent || a.innerText } function i(f) {
            var h = 0, e = 0, d = 0, b; if (b = f.getData()) {
                if (a.showCharCount) if (d = b, a.countHTML) d = d.length; else {
                    var g; if (c.config.fullPage && (g = d.search(/<body>/i), -1 != g)) var i = d.search(/<\/body>/i), d = d.substring(g +
6, i); g = d; a.countSpacesAsChars || (g = d.replace(/\s/g, "").replace(/&nbsp;/g, "")); g = g.replace(/(\r\n|\n|\r)/gm, "").replace(/&nbsp;/gi, " "); g = q(g).replace(/^([\t\r\n]*)$/, ""); d = g.length
                } a.showParagraphs && (h = b.replace(/&nbsp;/g, " ").replace(/(<([^>]+)>)/ig, "").replace(/^\s*$[\n\r]{1,}/gm, "++").split("++").length); if (a.showWordCount) {
                    e = b.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace("&nbsp;", " "); e = q(e); e = e.split(/\s+/); for (b = e.length - 1; 0 <= b; b--) e[b].match(/^([\s\t\r\n]*)$/) && e.splice(b,
1); e = e.length
                } 
            } h = r.replace("%wordCount%", e).replace("%charCount%", d).replace("%paragraphs%", h); f.plugins.wordcount.wordCount = e; f.plugins.wordcount.charCount = d; CKEDITOR.env.gecko ? l(f).innerHTML = h : l(f).innerText = h; if (d == j && e == k) return !0; h = e - k; b = d - j; k = e; j = d; -1 == k && (k = e); -1 == j && (j = d); if (-1 < a.maxWordCount && e > a.maxWordCount && 0 < h || -1 < a.maxCharCount && d > a.maxCharCount && 0 < b) {
                if (h = n, n = !0, o = !1, a.hardLimit && (f.loadSnapshot(p), f.config.Locked = 1), !h) l(f).className = "cke_path_item cke_wordcountLimitReached", f.fire("limitReached",
{}, c)
            } else !o && (-1 == a.maxWordCount || e < a.maxWordCount) && (-1 == a.maxCharCount || d < a.maxCharCount) ? (o = !0, n = !1, f.config.Locked = 0, p = c.getSnapshot(), l(f).className = "cke_path_item") : p = f.getSnapshot(); a.charCountGreaterThanMaxLengthEvent && a.charCountLessThanMaxLengthEvent && (d > a.maxCharCount && -1 < a.maxCharCount ? a.charCountGreaterThanMaxLengthEvent(d, a.maxCharCount) : a.charCountLessThanMaxLengthEvent(d, a.maxCharCount)); a.wordCountGreaterThanMaxLengthEvent && a.wordCountLessThanMaxLengthEvent && (e > a.maxWordCount && -1 <
a.maxWordCount ? a.wordCountGreaterThanMaxLengthEvent(e, a.maxWordCount) : a.wordCountLessThanMaxLengthEvent(e, a.maxWordCount)); return !0
        } var b = "", k = -1, j = -1, n = !1, o = !1, p = c.getSnapshot(), m = function (a, b, c) { if ("undefined" != typeof document.dispatchEvent) { var a = "ckeditor.wordcount." + a, d, b = { bubbles: !1, cancelable: !0, detail: { currentLength: b, maxLength: c} }; try { d = new CustomEvent(a, b) } catch (i) { d = document.createEvent("CustomEvent"), d.initCustomEvent(a, b.bubbles, b.cancelable, b.detail) } document.dispatchEvent(d) } }, a = CKEDITOR.tools.extend({ showParagraphs: !0,
            showWordCount: !0, showCharCount: !1, countSpacesAsChars: !1, countHTML: !1, hardLimit: !0, maxWordCount: -1, maxCharCount: -1, wordCountGreaterThanMaxLengthEvent: function (a, b) { m("wordCountGreaterThanMaxLengthEvent", a, b) }, charCountGreaterThanMaxLengthEvent: function (a, b) { m("charCountGreaterThanMaxLengthEvent", a, b) }, wordCountLessThanMaxLengthEvent: function (a, b) { m("wordCountLessThanMaxLengthEvent", a, b) }, charCountLessThanMaxLengthEvent: function (a, b) { m("charCountLessThanMaxLengthEvent", a, b) } 
        }, c.config.wordcount || {},
!0); a.showParagraphs && (b += c.lang.wordcount.Paragraphs + " %paragraphs%"); if (a.showParagraphs && (a.showWordCount || a.showCharCount)) b += ", "; a.showWordCount && (b += c.lang.wordcount.WordCount + " %wordCount%", -1 < a.maxWordCount && (b += "/" + a.maxWordCount)); a.showCharCount && a.showWordCount && (b += ", "); a.showCharCount && (b += c.lang.wordcount[a.countHTML ? "CharCountWithHTML" : "CharCount"] + " %charCount%", -1 < a.maxCharCount && (b += "/" + a.maxCharCount)); var r = b; (void 0 === a.loadCss || a.loadCss) && CKEDITOR.document.appendStyleSheet(this.path +
"css/wordcount.css"); c.on("key", function (a) { c.mode === "source" && i(a.editor) }, c, null, 100); c.on("change", function (a) { i(a.editor) }, c, null, 100); c.on("uiSpace", function (a) {
    if (c.elementMode === CKEDITOR.ELEMENT_MODE_INLINE) { if (a.data.space == "top") a.data.html = a.data.html + ('<div class="cke_wordcount" style="" title="' + c.lang.wordcount.title + '"><span id="' + ("cke_wordcount_" + a.editor.name) + '" class="cke_path_item">&nbsp;</span></div>') } else if (a.data.space == "bottom") a.data.html = a.data.html + ('<div class="cke_wordcount" style="" title="' +
c.lang.wordcount.title + '"><span id="' + ("cke_wordcount_" + a.editor.name) + '" class="cke_path_item">&nbsp;</span></div>')
}, c, null, 100); c.on("dataReady", function (a) { i(a.editor) }, c, null, 100); c.on("afterPaste", function (a) { i(a.editor) }, c, null, 100); c.on("blur", function () { }, c, null, 300)
    } 
    }); CKEDITOR.plugins.add("zoom", { requires: ["richcombo"], init: function (d) {
        var f = d.config, e = CKEDITOR.document.getHead().append("style"); e.setAttribute("type", "text/css"); CKEDITOR.env.ie && 11 > CKEDITOR.env.version ? e.$.styleSheet.cssText = ".cke_combopanel__zoom { height: 200px; width: 100px; }.cke_combo__zoom .cke_combo_text { width: 40px;}" : e.$.innerHTML = ".cke_combopanel__zoom { height: 200px; width: 100px; }.cke_combo__zoom .cke_combo_text { width: 40px;}"; d.ui.addRichCombo("Zoom", { label: "Zoom", title: "Zoom",
            multiSelect: !1, className: "zoom", modes: { wysiwyg: 1, source: 1 }, panel: { css: [CKEDITOR.skin.getPath("editor")].concat(f.contentsCss) }, init: function () { var c = [50, 75, 100, 125, 150, 200, 400], a; this.startGroup("Zoom level"); for (var b = 0; b < c.length; b++) a = c[b], this.add(a + "", a + " %", a + " %"); this.setValue("100", "100 %") }, onClick: function (c) {
                var a = d.editable().$, b = parseInt(c); a.style.MozTransformOrigin = "top left"; a.style.MozTransform = "scale(" + b / 100 + ")"; a.style.WebkitTransformOrigin = "top left"; a.style.WebkitTransform = "scale(" +
b / 100 + ")"; a.style.OTransformOrigin = "top left"; a.style.OTransform = "scale(" + b / 100 + ")"; a.style.TransformOrigin = "top left"; a.style.Transform = "scale(" + b / 100 + ")"; a.style.zoom = b / 100; this.setValue(c, c + " %"); this.lastValue = c
            }, onRender: function () { d.on("mode", function () { if (this.lastValue) this.onClick(this.lastValue) }, this) } 
        })
    } 
    }); CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,enterkey,entities,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,format,horizontalrule,htmlwriter,iframe,wysiwygarea,indent,indentblock,indentlist,smiley,link,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,preview,print,removeformat,save,selectall,showblocks,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,undo,wsc,popup,filebrowser,forms,image,justify,language,pastefromword,showborders,autogrow,autocorrect,backgrounds,base64image,lineutils,widget,chart,image2,fontawesome,imgbrowse,imagebrowser,imagepaste,imageresize,imagerotate,pastebase64,simplebutton,SimpleImage,stat,tabbedimagebrowser,texttransform,textsignature,toolbarswitch,xdsoft_translater,tweetabletext,wordcount,zoom'; CKEDITOR.config.skin = 'moono'; (function () { var setIcons = function (icons, strip) { var path = CKEDITOR.getUrl('plugins/' + strip); icons = icons.split(','); for (var i = 0; i < icons.length; i++) CKEDITOR.skin.icons[icons[i]] = { path: path, offset: -icons[++i], bgsize: icons[++i] }; }; if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,bidiltr,168,,bidirtl,192,,blockquote,216,,copy-rtl,240,,copy,264,,cut-rtl,288,,cut,312,,paste-rtl,336,,paste,360,,bgcolor,384,,textcolor,408,,templates-rtl,432,,templates,456,,creatediv,480,,find-rtl,504,,find,528,,replace,552,,flash,576,,horizontalrule,600,,iframe,624,,indent-rtl,648,,indent,672,,outdent-rtl,696,,outdent,720,,smiley,744,,anchor-rtl,768,,anchor,792,,link,816,,unlink,840,,bulletedlist-rtl,864,,bulletedlist,888,,numberedlist-rtl,912,,numberedlist,936,,maximize,960,,newpage-rtl,984,,newpage,1008,,pagebreak-rtl,1032,,pagebreak,1056,,pastetext-rtl,1080,,pastetext,1104,,preview-rtl,1128,,preview,1152,,print,1176,,removeformat,1200,,save,1224,,selectall,1248,,showblocks-rtl,1272,,showblocks,1296,,source-rtl,1320,,source,1344,,specialchar,1368,,scayt,1392,,table,1416,,redo-rtl,1440,,redo,1464,,undo-rtl,1488,,undo,1512,,spellchecker,1536,,button,1560,,checkbox,1584,,form,1608,,hiddenfield,1632,,imagebutton,1656,,radio,1680,,select-rtl,1704,,select,1728,,textarea-rtl,1752,,textarea,1776,,textfield-rtl,1800,,textfield,1824,,image,1848,,justifyblock,1872,,justifycenter,1896,,justifyleft,1920,,justifyright,1944,,language,1968,,pastefromword-rtl,1992,,pastefromword,2016,,autocorrect--,4080,auto,autocorrect,2064,,autocorrect-,2088,,base64image,2112,,chart,4272,auto,fontawesome,4320,auto,rotate-left,2184,,rotate-right,2208,,simpleimage,4464,auto,toolbarswitch,2256,,xdsoft_translater,4560,auto,xdsoft_translater_reverse,4608,auto,xdsoft_translater_settings,4656,auto,tweetabletext,4704,auto', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,bidiltr,168,auto,bidirtl,192,auto,blockquote,216,auto,copy-rtl,240,auto,copy,264,auto,cut-rtl,288,auto,cut,312,auto,paste-rtl,336,auto,paste,360,auto,bgcolor,384,auto,textcolor,408,auto,templates-rtl,432,auto,templates,456,auto,creatediv,480,auto,find-rtl,504,auto,find,528,auto,replace,552,auto,flash,576,auto,horizontalrule,600,auto,iframe,624,auto,indent-rtl,648,auto,indent,672,auto,outdent-rtl,696,auto,outdent,720,auto,smiley,744,auto,anchor-rtl,768,auto,anchor,792,auto,link,816,auto,unlink,840,auto,bulletedlist-rtl,864,auto,bulletedlist,888,auto,numberedlist-rtl,912,auto,numberedlist,936,auto,maximize,960,auto,newpage-rtl,984,auto,newpage,1008,auto,pagebreak-rtl,1032,auto,pagebreak,1056,auto,pastetext-rtl,1080,auto,pastetext,1104,auto,preview-rtl,1128,auto,preview,1152,auto,print,1176,auto,removeformat,1200,auto,save,1224,auto,selectall,1248,auto,showblocks-rtl,1272,auto,showblocks,1296,auto,source-rtl,1320,auto,source,1344,auto,specialchar,1368,auto,scayt,1392,auto,table,1416,auto,redo-rtl,1440,auto,redo,1464,auto,undo-rtl,1488,auto,undo,1512,auto,spellchecker,1536,auto,button,1560,auto,checkbox,1584,auto,form,1608,auto,hiddenfield,1632,auto,imagebutton,1656,auto,radio,1680,auto,select-rtl,1704,auto,select,1728,auto,textarea-rtl,1752,auto,textarea,1776,auto,textfield-rtl,1800,auto,textfield,1824,auto,image,1848,auto,justifyblock,1872,auto,justifycenter,1896,auto,justifyleft,1920,auto,justifyright,1944,auto,language,1968,auto,pastefromword-rtl,1992,auto,pastefromword,2016,auto,autocorrect--,2040,auto,autocorrect,2064,auto,base64image,2088,auto,chart,2112,auto,fontawesome,2136,auto,rotate-left,2160,auto,rotate-right,2184,auto,simpleimage,2208,auto,toolbarswitch,2232,auto,xdsoft_translater,2256,auto,xdsoft_translater_reverse,2280,auto,xdsoft_translater_settings,2304,auto,tweetabletext,2328,auto', 'icons.png'); })(); CKEDITOR.lang.languages = { "en": 1, "ka": 1, "ru": 1 };
} ());