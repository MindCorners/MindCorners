...
{
    public class MyVideoPlayerRenderer : ViewRenderer<MyVideoPlayer, Android.Widget.LinearLayout>
    {
        private MediaController _MCController;
        private MyVideoView _MyVideoView;
        private bool _AttachedController;
        private Android.Widget.LinearLayout _MainLayout;
  ...
  //this._MyVideoView.LoadFile("https://www.facebook.com/TheBearWay/videos/1364470410275596/");
        ...
        private void ResizeScreen(bool fullscreen)
        {
            ...
            if (fullscreen)
            {
                var p = this._MyVideoView.LayoutParameters as Android.Widget.LinearLayout.LayoutParams;
                p.Width = Android.Widget.LinearLayout.LayoutParams.FillParent;
                ...
                var width = (this.Element.ActionBarHide) ? rect.Width() : (int)Element.ContentWidth;
