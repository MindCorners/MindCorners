...
namespace MindCorners.CustomControls
{
    public class GesturesContentView : ContentView
    {
        ...
        /// </summary>
        /// 
        //private static BindableProperty accuracyProperty = BindableProperty.Create<GesturesContentView, float>(x => x.Accuracy, 5.0f, BindingMode.OneWay, (bo, val) => val >= 5 && val <= 25);
        //public static BindableProperty AccuracyProperty = BindableProperty.Create("Accuracy", typeof(float), typeof(GesturesContentView), 5.0f, BindingMode.OneWay, ((bo, val) => val >= 5 && val <= 25)) ;
        private static BindableProperty accuracyProperty = BindableProperty.Create(nameof(Accuracy), typeof(float), typeof(GesturesContentView), 5.0f, BindingMode.OneWay, (bo, val) => (float)val >= 5 && (float)val <= 25);
        /// <summary>
...
public bool ExcludeChildren
        ...
        public static BindableProperty AccuracyProperty
        {
            ...
            set
            {
                accuracyProperty = value;
            }
        }

        public static BindableProperty AccuracyProperty1
        {
            get
            {
                return accuracyProperty;
